...
<div class="card col-lg-4 col-lg-offset-4 mt-4">
    ...
    <h5 class="card-header info-color white-text text-center py-4 ">
        <strong>Anunciar produto para venda</strong>
    </h5>
    ...
    <div class="card-body px-lg-5">
        ...
        <!-- Form -->
        <form action ="anuncioP.php" class="text-center" style="color: #757575;" method="post">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" name = "preco" class="form-control" placeholder="Preço, 0 se troca ou doação" aria-label="preco" aria-describedby="basic-addon1">
            </div>
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <label class="input-group-text" for="inputGroupSelect02">Operação</label>
                </div>
