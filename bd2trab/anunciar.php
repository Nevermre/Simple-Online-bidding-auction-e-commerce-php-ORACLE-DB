...
<div class="card col-lg-4 col-lg-offset-4 mt-4">
    ...
    <h5 class="card-header info-color white-text text-center py-4 ">
        <strong>Anunciar Serviço</strong>
    </h5>
    ...
    <div class="card-body px-lg-5">
        ...
        <!-- Form -->
        <form action ="anuncio.php" class="text-center" style="color: #757575;" method="post">

            <p>Forneça algumas informações sobre o seu serviço.</p>
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="basic-addon1">R$/hora</span>
                </div>
                <input type="text" name = "preco" class="form-control" placeholder="Preço" aria-label="preco" aria-describedby="basic-addon1">
            </div>
