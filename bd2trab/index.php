    	...
    	<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
                  ...
                  <div class="form-group">
										<input type="text" name="telefone" id="telefone" tabindex="2" class="form-control" placeholder="Telefone">
									</div>


									<div class="form-group">
										<input type="text" name="telefone2" id="telefone2" tabindex="2" class="form-control" placeholder="Telefone2">
									</div>
									
                  <div class="form-group">
										<input type="text" name="telefone3" id="telefone3" tabindex="2" class="form-control" placeholder="Telefone3">
									</div>
									
                  <div class="form-group">
										<input type="text" name="telefone4" id="telefone4" tabindex="2" class="form-control" placeholder="Telefone4">
									</div>
									
                  <div class="form-group">
										<input type="text" name="telefone5" id="telefone5" tabindex="2" class="form-control" placeholder="Telefone5">
									</div>
